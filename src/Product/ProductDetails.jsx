...
const ProductDetails = () => {
  ...
  let [prevCartData, setCardData] = useState();
        ...
        >
          ...
          >
            ...
            <Grid item xs={12} sm={6}>
              ...
              >
                Category:{" "}
                <span style={{ fontWeight: 500,color:"tomato",cursor:"pointer" }} onClick={()=>handleCategory(dataSet?.category)}>{dataSet?.category}</span>
              </Typography>
              ...
              <Typography variant="body1" color="textSecondary" gutterBottom style={{ fontWeight: 800 }}>
                Country of Origin:{" "}
